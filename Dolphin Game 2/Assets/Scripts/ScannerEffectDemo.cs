...
public class ScannerEffectDemo : MonoBehaviour
{
	...
	void OnRenderImage(RenderTexture src, RenderTexture dst)
	{
		...
		//float[] scanDistances = new float[10];
		//scanDistances[0] = ScanDistance;
		//EffectMaterial.SetFloatArray("_ScanDistances", scanDistances);
    ...
    {
        OnRenderImage(camera.activeTexture, camera.targetTexture);
